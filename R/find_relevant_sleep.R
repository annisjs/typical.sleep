...
find_relevant_sleep <- function(all_sleep_dat)
{
    ...
    first_last_asleep[, median_msp_date := lubridate::ymd(lubridate::as_date(start_time)) + lubridate::hms(median_msp)]
    ...
    dt_overlaps <- data.table::foverlaps(all_sleep_dat, first_last_asleep_ranges, type = "any", nomatch = NULL, which = TRUE)
    ...
    dt_overlaps2 <- data.table::foverlaps(all_sleep_dat, first_last_asleep_ranges, type = "any", nomatch = NULL, which = TRUE)
    ...
    dt_overlaps3 <- data.table::foverlaps(all_sleep_dat, first_last_asleep_ranges, type = "any", nomatch = NULL, which = TRUE)
